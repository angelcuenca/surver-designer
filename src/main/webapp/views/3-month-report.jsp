...
<body>
                ...
                <div class="col-xs-12 padding-0">
                    <div class="col-sm-6 col-xs-2">
                        <div class="row">
                            ...
                            <p class="pull-left h4 uppercase navbar-text hidden-xs">3 Month Overview Report</p>
                        </div>
                    </div>
    ...
    <script type="text/babel" src="${pageContext.request.contextPath}/statics/js/surveyengine.react.3-month-report-table.js"></script>
    <script>
        var ReactTable = window.ReactTable.default;

        const reports = SurveyEngine.commons.reportsUtil;
        reports.downloadExcel('3-month');
