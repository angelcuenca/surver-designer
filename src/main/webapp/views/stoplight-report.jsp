...
<body>
                    ...
                    <div class="col-sm-6 col-xs-2">
                        <div class="row">
                            ...
                            <!-- hidden on smartphones -->
                                <p class="pull-left h4 uppercase navbar-text hidden-xs">Monthly Stoplight Report </p>
                        </div>
                    </div>
    ...
    <script type="text/babel" src="${pageContext.request.contextPath}/statics/js/surveyengine.react.stoplight-report-table.js"></script>
    <script>
        var ReactTable = window.ReactTable.default;

        const reports = SurveyEngine.commons.reportsUtil;
        reports.downloadExcel('stoplight');
    </script>
</body>
</html>
