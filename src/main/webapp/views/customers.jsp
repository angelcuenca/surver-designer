...
<html lang="en">
                ...
                <div class="row">
                    <div class="col-xs-12 padding-0">
                        <div class="col-sm-6 col-xs-2">
                            <div class="row">
                                <p class="pull-left h4 uppercase navbar-text hidden-xs" style="color: white;">Customers Catalog</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="DeleteCustomerModal">
    ...
    <script type="text/babel" src="${pageContext.request.contextPath}/statics/js/surveyengine.react.customers.js"></script>
