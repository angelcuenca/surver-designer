...
<div>
            ...
            <div class="row">
                <div class="col-xs-12 padding-0">
                    <div class="col-sm-6 col-xs-2">
                        <div class="row">
                            <p class="pull-left h4 uppercase navbar-text hidden-xs" style="color: white;">Rating Types</p>
                        </div>
                    </div>
                    <div class="col-sm-4 col-sm-offset-0 pull-right">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 col-lg-6 pull-right">
                                <div id="btn-add-rating-type"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="container-fluid mbottom-20" id="main-content-user">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-1 clearfix panel-user">
                <div class="main-role-form panel panel-default mbottom-10">
                    <div class="panel-heading uppercase text-bold clearfix">
                        <p class="mbottom-0 pull-left">RATING</p>
                    </div>
                    <div class="panel-body">
                        <section>
                            <div class="col-lg-12 col-md-12">
                                <div id="table-rating-type"></div>
                            </div>
                        </section>
                    </div>
                </div>
...
<!-- M O D A L   T O  A D D /  E D I T / R E M O V E   R A T I N G   T Y P E   -->
<div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="ModalRatingType">
    <div class="modal-dialog modal-md">
        <div class="modal-content">

            <div id="add-rating-type"></div>
...
<script type="text/babel" src="${pageContext.request.contextPath}/statics/js/surveyengine.react.rating-type.js"></script>
