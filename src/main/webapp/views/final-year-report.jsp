...
<body>
                    ...
                    <div class="col-sm-6 col-xs-2">
                        <div class="row">
                            ...
                            <!-- hidden on smartphones -->
                                <p class="pull-left h4 uppercase navbar-text hidden-xs">Yearly overall average ratings </p>
                        </div>
                    </div>
    ...
    <script src="${pageContext.request.contextPath}/statics/js/match-sorter.js"></script>
    <script src="${pageContext.request.contextPath}/statics/js/diacritics.js"></script>
    <script src="${pageContext.request.contextPath}/statics/js/chart.bundle.js"></script>
    <script src="${pageContext.request.contextPath}/statics/js/chartkick-2.2.4.js"></script>
    <script src="${pageContext.request.contextPath}/statics/js/react-chartkick-0.1.6.js"></script>
    <script type="text/babel" src="${pageContext.request.contextPath}/statics/js/surveyengine.react.final-report-year-table.js"></script>
    <script>
        var ReactTable = window.ReactTable.default;

        const reports = SurveyEngine.commons.reportsUtil;
        reports.downloadExcel('final-year');
