...
<body>
                ...
                <div class="col-xs-12 padding-0">
                    <div class="col-sm-6 col-xs-2">
                        <div class="row">
                            ...
                            <p class="pull-left h4 uppercase navbar-text hidden-xs">Monthly Unrecorded Ratings Report</p>
                        </div>
                    </div>
    ...
    <script type="text/babel" src="${pageContext.request.contextPath}/statics/js/surveyengine.react.unrecorded-table.js"></script>
    <script>
        var ReactTable = window.ReactTable.default;
        const reports = SurveyEngine.commons.reportsUtil;
        reports.downloadExcel('unrecorded');
    </script>
</body>
</html>
